...
This was created for EVE Online's Spy Meta. This was made after managing Intel related stuff for many years after managing one of the largest Intelligence Organizations in the game. I had written this as a thank you to one of my members seperately from all the tools I had written after he joined and helped me out a lot. This script includes many tricks such as preventing force embedding to detect the channels are being relayed, pretending to be a web client. This is a basic version made from scratch, there are a few bugs which will eventually be ironed out. Mainly role and username's not being converted their display names.
